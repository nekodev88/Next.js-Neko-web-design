...
const ServiceFeature = () => {
  ...
  return (
    <section className="w-full h-auto my-20 md:my-32 flex flex-col justify-between items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10 w-full">
        {serviceFeatureSection.map((item, index) => (
          <div key={index} className="group relative col-span-1 bg-transparent flex flex-col min-h-[250px] overflow-hidden rounded-3xl">
            <img
              src={item.pic}
